...
public static class Courses
{
    ...
    )
    {
        ...
        CoursesList.FirstOrDefault(a => a.IdCourse == id)!.WorkLoad = workLoad;

        CoursesList.FirstOrDefault(a => a.IdCourse == id)!.Name =
            name; // Update the course name.
        CoursesList.FirstOrDefault(a => a.IdCourse == id)!.WorkLoad =
    ...
    public static string GetFullName(int id)
    {
        ...
        return $"{course.IdCourse,5} | {course.Name} {course.Credits}";
    }
